...
import React, {
  ...
  export default function HomeView() {
    ...
    function ShowCircleMarker() {
      ...
      var showCircleMarker_func = participants.map((participant) => {
            ...
            return (
              ...
              <ListItem key={value} button onClick={() => SelectParticipant(index)}>
                ...
                <ListItemSecondaryAction>
                    {participant.outOfBattery === true ? (
                      // <IconButton onClick={() => window.location.href = '#'}>
                        <BatteryAlertIcon />  
                      // </IconButton>
                    ) : ''}
                    
                    {participant.placeAlert === true ? (
                      // <IconButton>
                        <AnnouncementIcon/>
                      // </IconButton>
                    ) : ''}
                    
                    {participant.heartRate === true ? (
                      // <IconButton onClick={() => window.location.href = '#'}>
                        <FavoriteIcon/>
                      // </IconButton>
                    ) : ''}
                    
                    {participant.calendar === true ? (
                      // <IconButton onClick={() => window.location.href = '#'}>
                        <DateRangeIcon/>
                      // </IconButton>
                    ) : ''}
