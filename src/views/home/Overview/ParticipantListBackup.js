...
import {
  ...
  class ParticipantList extends React.Component {
    constructor(props) {
      super(props);
      this.state = { toggleCircleMarker: toggleCircleMarkerData, toggleCMState: true };
  
      this.classes = useStyles();
      this.participants = participantData;
      // this.toggleCircleMarker = useState(toggleCircleMarkerData);
      // this.toggleCMState = useState(true);
      this.participantContext = useContext(ParticipantContext);
    }
